...
public class Student_Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_password = findViewById(R.id.et_student_login_password);
        submit_button = findViewById(R.id.bt_student_login_submit);
        et_email = findViewById(R.id.et_student_login_email);
        forgotPassword = findViewById(R.id.tv_student_forgot_password);
        ...
        if (mUser!=null){
            ...
            Intent login = new Intent(Student_Login.this, StudentHome.class);
        ...
        hud = KProgressHUD.create(this)
                ...
                .setDetailsLabel("Logging Student in...")
                .setCancellable(true)
                .setAnimationSpeed(2)
                .setDimAmount(0.5f)
        ...
        forgotPassword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent login = new Intent(Student_Login.this, PasswordReset.class);
                login.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                login.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK|Intent.FLAG_ACTIVITY_NEW_TASK);

...
public class AllStudents2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_all_students2);

        mUsersRecycler = findViewById(R.id.all_students_recycler2);
                        ...
                        try {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    if (dataSnapshot.exists()){
                                        ...
                                        if (dataSnapshot.hasChild("photoUrl")){
                                            ...
                                            Picasso.get().load(dataSnapshot.child("photoUrl").getValue().toString())
                            ...
                            holder.itemView.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    Intent all_students = new Intent(getApplicationContext(), ClearStudent.class);
